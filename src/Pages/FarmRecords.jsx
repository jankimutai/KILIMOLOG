...
const FarmRecords = () => {
  ...
  useEffect(() => {
    ...
    const dummyData = [
      { id: 1, date: '2024-06-01', activityType: 'Planting', description: 'Planted corn', estimatedCost: 100, season: '2023' },
      { id: 2, date: '2024-06-02', activityType: 'Harvesting', description: 'Harvested wheat', estimatedCost: 50, season: '2024' },
      { id: 3, date: '2024-06-03', activityType: 'Spraying', description: 'Sprayed pesticides', estimatedCost: 80, season: '2024' },
      { id: 4, date: '2024-06-04', activityType: 'Planting', description: 'Planted tomatoes', estimatedCost: 120, season: '2024' },
      { id: 5, date: '2024-06-05', activityType: 'Labour', description: 'Hired labor for harvesting', estimatedCost: 200, season: '2024' },
      { id: 6, date: '2024-06-06', activityType: 'Top Dressing', description: 'Applied fertilizer', estimatedCost: 60, season: '2024' },
      { id: 7, date: '2024-06-07', activityType: 'Harvesting', description: 'Harvested maize', estimatedCost: 70, season: '2024' },
      { id: 1, date: '2024-06-01', activityType: 'Planting', description: 'Planted corn', estimatedCost: 100, season: '2023' },
      { id: 2, date: '2024-06-02', activityType: 'Harvesting', description: 'Harvested wheat', estimatedCost: 50, season: '2024' },
      { id: 3, date: '2024-06-03', activityType: 'Spraying', description: 'Sprayed pesticides', estimatedCost: 80, season: '2024' },
      { id: 4, date: '2024-06-04', activityType: 'Planting', description: 'Planted tomatoes', estimatedCost: 120, season: '2024' },
